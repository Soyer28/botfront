...
var renderCheckboxes = function (_a) {
    ...
    return allowedValues.map(function (item) { return (react_1.default.createElement("div", { className: "field", key: item },
        react_1.default.createElement("div", { className: "ui checkbox" },
            react_1.default.createElement("input", { checked: fieldType === Array ? value.includes(item) : value === item, disabled: disabled, id: id + "-" + item, name: name, onChange: function () {
                    return onChange(fieldType === Array ? xor(item, value) : item);
                }, type: "checkbox" }),
...
var renderSelect = function (_a) {
    ...
    return (react_1.default.createElement("select", { className: "ui selection dropdown", disabled: disabled, id: id, name: name, onChange: function (event) {
...
var Select = function (_a) {
    var allowedValues = _a.allowedValues, checkboxes = _a.checkboxes, className = _a.className, disabled = _a.disabled, error = _a.error, errorMessage = _a.errorMessage, fieldType = _a.fieldType, id = _a.id, inputRef = _a.inputRef, label = _a.label, name = _a.name, onChange = _a.onChange, placeholder = _a.placeholder, required = _a.required, showInlineError = _a.showInlineError, transform = _a.transform, value = _a.value, props = tslib_1.__rest(_a, ["allowedValues", "checkboxes", "className", "disabled", "error", "errorMessage", "fieldType", "id", "inputRef", "label", "name", "onChange", "placeholder", "required", "showInlineError", "transform", "value"]);
